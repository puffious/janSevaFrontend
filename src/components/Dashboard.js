...
const Dashboard = ({ user, onLogout }) => {
  ...
  useEffect(() => {
    ...
    if (
      path &&
      ["overview", "issues", "map", "assignments", "analytics"].includes(path)
    ) {
      setActiveTab(path);
    }
  }, [location]);
            ...
            return (
              <div
                ...
                style={{
                  ...styles.navItem,
                  backgroundColor:
                    activeTab === item.id ? "#007bff" : "transparent",
                }}
      ...
      <div style={styles.mainContent}>
        ...
        <div style={styles.content}>
          <Routes>
            ...
            <Route
              path="/issues"
              element={<IssuesList user={user} searchQuery={searchQuery} />}
            />
  ...
  return (
    <div>
      <div style={styles.statsGrid}>
        ...
        <div style={styles.statCard}>
          <div style={{ ...styles.statNumber, color: "#ffeaa7" }}>
            {stats.new}
          </div>
          <div style={styles.statLabel}>New Issues</div>
        </div>
        <div style={styles.statCard}>
          <div style={{ ...styles.statNumber, color: "#fd79a8" }}>
            {stats.assigned}
          </div>
          <div style={styles.statLabel}>Assigned</div>
        </div>
        <div style={styles.statCard}>
          <div style={{ ...styles.statNumber, color: "#fdcb6e" }}>
            {stats.inProgress}
          </div>
          <div style={styles.statLabel}>In Progress</div>
        </div>
        <div style={styles.statCard}>
          <div style={{ ...styles.statNumber, color: "#00b894" }}>
            {stats.resolved}
          </div>
      ...
      <div style={styles.recentActivity}>
        ...
        <div style={styles.activityList}>
          <div style={styles.activityItem}>
            ...
            <div>
              <strong>Issue #1234</strong> assigned to Suresh Patel
          ...
          <div style={styles.activityItem}>
            <div style={styles.activityDot}></div>
            <div>
              New issue reported in Jayanagar
