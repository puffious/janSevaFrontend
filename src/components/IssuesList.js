...
const IssuesList = ({ user, searchQuery }) => {
      ...
      },
      {
        ...
        timeline: [
          ...
          },
          {
            ...
            action: "Assigned to Kavitha Nair",
            user: "Supervisor",
          },
          {
      ...
      },
      {
        ...
        timeline: [
          ...
          },
          {
            ...
            action: "Assigned to Ravi Krishnan",
            user: "Supervisor",
          },
          {
  ...
  const getStatusColors = (status) => {
    switch (status) {
      case "new":
        return { backgroundColor: "#ffeaa7", color: "#2d3436" };
      case "verified":
        return { backgroundColor: "#74b9ff", color: "white" };
      case "assigned":
        return { backgroundColor: "#fd79a8", color: "white" };
      case "in-progress":
        return { backgroundColor: "#fdcb6e", color: "#2d3436" };
      case "resolved":
  ...
  const handleAssignIssue = (issueId) => {
    ...
    setIssues((prev) =>
      prev.map((issue) =>
        issue.id === issueId
          ? { ...issue, status: "assigned", assignedTo: "Amit Singh" }
          : issue,
      ),
    );
  };
